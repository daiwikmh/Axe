          ...
          messages: [
            {
              role: "system",
              content:
                "You are an autonomous DeFi yield optimizer managing ~1 USDC across L2 chains. Decide whether to move capital to a higher-yielding chain. Respond ONLY with valid JSON.",
            },
            {
              role: "user",
              content: `${currentInfo}
